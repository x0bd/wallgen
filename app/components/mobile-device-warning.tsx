    ...
    <div className="fixed inset-0 bg-white dark:bg-black z-50 flex flex-col items-center justify-center px-6 py-10 overflow-auto">
      <div className="neo-brutal max-w-sm mx-auto flex flex-col items-center p-8 text-center space-y-8 bg-gradient-to-br from-black/[0.02] to-black/[0.05] dark:from-white/[0.02] dark:to-white/[0.05]">
        ...
        <div className="space-y-4">
          ...
          >
            WallGen is designed for larger screens. The mobile version is still a work in progress.
          </motion.p>
          ...
          >
            ...
            <span>For best experience, please use a desktop device</span>
          </motion.div>
        </div>
      ...
      <p className="mt-6 text-xs font-mono opacity-50 max-w-sm text-center">
        WallGen is a processor-intensive generative art application and may run slower on mobile devices.
      </p>
    </div>
  )
} 